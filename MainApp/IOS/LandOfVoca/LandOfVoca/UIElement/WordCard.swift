...
//  LandOfVoca
//
//  Created by ChenZengzhan on 2018-07-19.
//  Copyright © 2018 teamtiger. All rights reserved.
//

import UIKit

protocol WordCardDelegate: NSObjectProtocol {
...
class WordCard: UIView {
    ...
    func setUpView(){
        ...
        profileImageView.image = UIImage(named:"profile_image1")
        ...
        let attributedText = NSMutableAttributedString(string: representedWord.english!, attributes: [.foregroundColor: UIColor.white,.font:UIFont.boldSystemFont(ofSize: 25)])
        attributedText.append(NSAttributedString(string: "\n第三次", attributes: [.foregroundColor: UIColor.white,.font:UIFont.systemFont(ofSize: 18)]))
